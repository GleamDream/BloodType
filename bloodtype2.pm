...
module blood
	...
	[firstphase] s=0 -> 1/9:(parent1'=AA)&(s'=1) + 2/9:(parent1'=AB)&(s'=1) + 1/9:(parent1'=BB)&(s'=1) + 2/9:(parent1'=AO)&(s'=1) + 2/9:(parent1'=BO)&(s'=1) + 1/9:(parent1'=OO)&(s'=1);
	[firstphase] s=1 -> 1/9:(parent2'=AA)&(s'=2) + 2/9:(parent2'=AB)&(s'=2) + 1/9:(parent2'=BB)&(s'=2) + 2/9:(parent2'=AO)&(s'=2) + 2/9:(parent2'=BO)&(s'=2) + 1/9:(parent2'=OO)&(s'=2);
